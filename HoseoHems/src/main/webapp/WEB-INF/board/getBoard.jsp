			...
			<div>	
				...
				<table>
				  ...
				  <tr>
					...
					<td><textarea name="content" rows="10" cols="77">${board.content}</textarea></td>
				  </tr>
				</table>
				  <div class="button" align="right">
					 ...
					 <a href="">
					 <input type="image" src="resources/image/btn_modify.gif" style="vertical-align:bottom" >
					 </a>
					 <a href="deleteBoard_pro.jsp?seq=${board.seq}">
					 <img class="img" src="resources/image/btn_del.gif" style="vertical-align:bottom" alt="">
					 </a>
				  </div>
				</form>
			</div>	
